...
- Fixed stable marker IDs (#15), packed-append shadow sync (#16),
  hidden-layer hit-testing (#17), and tap coordinates (#18).
- Security clean: template ReDoS, benchmark XSS, serve format string,
  least-privilege CI, bumped deps. Zero open CodeQL/Dependabot alerts.
- The Jest suite now covers 824 tests.
...
- Added a VitePress navigation shell and a [20-use-case compatibility
  checklist](/use-cases).
- Added 20 parity scenarios; the Jest suite now covers 824 tests.
